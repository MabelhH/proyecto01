...
<head>
    ...
    <link rel="stylesheet" href="/paginaprincipal/admin.css">
    ...
    <div class="container">
        <header>
            <nav class="navbar">
                ...
                <ul class="menu">
                    <li><a href="/paginaprincipal/administrador.php">Nosotros</a></li>
                    <li><a href="/habitacion/habitacion.html">Habitaciones</a></li>
                    <li><a href="/crud/usuarios/mostarusu.php">R.Usuarios</a></li>
                    <li><a href="/crud/habitacion/mos.php">R.Habitaciones</a></li>
                    <li><a href="/crud/contactos/mostarcont.php">R.Contactos</a></li>
                </ul>
                <div class="buscador">
        ...
        <div class="carousel">
    <div class="gallery js-flickity" data-flickity-options='{"wrapAround": true, "autoPlay": 3000, "pauseAutoPlayOnHover": true}'>
            ...
            <div class="card-container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description">Description for card 4.</p>
                    </div>
                </div>
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!--<p class="card-description">Description for card 8.</p>-->
                    </div>
                </div>
                <div class="card">
